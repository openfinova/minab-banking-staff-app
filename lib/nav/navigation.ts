...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    title: "TP — search, fees, velocity limits, compensation, account history",
    icon: ArrowLeftRight,
    permissions: [
    ...
    items: [
      ...
      {
        label: "Transactions",
        title: "Search and manage TP transactions — GET /api/v1/transactions",
      ...
      },
      {
        ...
        title: "Statement layer — GET /api/v1/accounts/{id}/transactions",
  ...
  },
  {
    id: "loans",
    label: "Loans",
    title: "Lending & loan servicing — /api/v1/loan-*",
    icon: PiggyBank,
    permissions: [
    ...
    items: [
      ...
      {
        label: "Products",
        title: "Loan products — GET/POST /api/v1/loan-products",
        href: "/loans/products",
        icon: Package,
      ...
      {
        label: "Applications",
        title: "Queues — /api/v1/loan-applications",
      ...
      },
      {
        ...
        title: "POST /api/v1/loan-applications",
      ...
      {
        label: "Accounts",
        title: "Loan accounts — /api/v1/loan-accounts",
        href: "/loans/accounts",
        icon: Wallet,
        permissions: [Permissions.LoanRead],
      },
      {
        label: "Payments",
        title: "Cross-account — /api/v1/loan-payments",
        href: "/loans/payments",
        icon: CreditCard,
        permissions: [Permissions.LoanRead],
      },
      ...
      {
        label: "Reports",
        title: "Portfolio & exposure — loan APIs",
        href: "/loans/reports",
        icon: FileSpreadsheet,
        permissions: [Permissions.LoanRead],
      },
